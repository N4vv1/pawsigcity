<?php
/**
 * Reset Password Handler - Fixed
 * Only allows password reset after OTP verification
 */
...
// Verify OTP purpose is for password reset
if (!isset($_SESSION['otp_purpose']) || $_SESSION['otp_purpose'] !== 'reset_password') {
    echo json_encode(['success' => false, 'message' => 'Invalid OTP verification purpose']);
    exit;
}
...
try {
    ...
    // Update password in database (without updated_at if it doesn't exist)
